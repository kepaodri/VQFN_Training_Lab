...
The purpose of this project is to give different hobbyists without prior experience with this type of package the opportunity to perform soldering tests to reach a good level of mastery. Soldering can be done for example using both reflow hot plate and/or hot air gun. 
